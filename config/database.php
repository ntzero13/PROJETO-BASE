    ...
    */
    ...
    'connections' => [
        'central' => [
            ...
            'database' => env('CENTRAL_DB_DATABASE', env('DB_DATABASE', 'vistoria_central')),
        ...
        'tenant_template' => [
            ...
            'port' => env('TENANT_DB_PORT', env('CENTRAL_DB_PORT', env('DB_PORT', '5432'))),
            'database' => env('TENANT_DB_DATABASE', 'postgres'),
            'username' => env('TENANT_DB_USERNAME', env('CENTRAL_DB_USERNAME', env('DB_USERNAME', 'postgres'))),
            'password' => env('TENANT_DB_PASSWORD', env('CENTRAL_DB_PASSWORD', env('DB_PASSWORD', ''))),
            'charset' => 'utf8',
            'prefix' => '',
            'prefix_indexes' => true,
            'search_path' => 'public',
            'sslmode' => env('TENANT_DB_SSLMODE', env('CENTRAL_DB_SSLMODE', env('DB_SSLMODE', 'prefer'))),
        ],
